...
public class MainVerticalViewPager extends ViewPager {
    public MainVerticalViewPager(@NonNull Context context) {
        super(context);
        init();
    }

    public MainVerticalViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
